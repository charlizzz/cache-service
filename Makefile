...
cache: $@ ## Generate Pbs and build for cache
...
clean: clean_cache ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_cache: ## Clean generated files for cache
	${RM_F_CMD} cache/${PROTO_DIR}/*.pb.go
